...
namespace HEAPIFY_Manager_540.Controllers
{
    public class DrugsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DrugID,DrugName,Dose,HowLong")] Drug drug)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DrugID,DrugName,Dose,HowLong")] Drug drug)
        {
            if (ModelState.IsValid)
            {
