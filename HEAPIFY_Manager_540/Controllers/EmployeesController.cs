...
namespace HEAPIFY_Manager_540.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,MiddleName,LastName,AddressID,PhoneNumberID,Position,Department,EmployeeSSN,WorkEmail,EmployeeDateOfBirth")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,MiddleName,LastName,AddressID,PhoneNumberID,Position,Department,EmployeeSSN,WorkEmail,EmployeeDateOfBirth")] Employee employee)
        {
            if (ModelState.IsValid)
            {
